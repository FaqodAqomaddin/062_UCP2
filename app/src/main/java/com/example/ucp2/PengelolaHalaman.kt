...
import com.example.ucp2.data.DosBing.dosen
    ...
    Scaffold { inner ->
        ...
        NavHost(
            ...
            composable(route = PengelolaHalaman.Formulir.name) {
                ...
                HalamanDua(
                    dosenpembimbing1 = dosen.map { id -> context.resources.getString(id) },
                    dosenpembimbing2 = dosen.map { id -> context.resources.getString(id) },
